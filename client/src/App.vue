        ...
        <ul>
          ...
          <li>
            <button type="submit" class="btn btn-primary">
              <RouterLink to="/" class="rout" active-class="router-link"
                >Список предметов</RouterLink
              >
            </button>
          </li>
          <li>
          ...
          <li>
            <button type="submit" class="btn btn-primary">
              <RouterLink
                to="/reports/teachers/1/subjects"
                class="rout"
                active-class="router-link"
                >Оценки по классам</RouterLink
              >
            </button>
          </li>
          <li>
